...
- **tooltip**: the plugin has 10 built-in languages: `en zh zh_TW es fr de ar ja ko ru nl`, **no need for manual configuration**, intelligent recognition, automatic switching
